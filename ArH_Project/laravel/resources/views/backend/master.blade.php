                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="index.html">
                                <i class="fi-air-play"></i><span
                                    class="badge badge-danger badge-pill float-right">7</span> <span> Dashboard </span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li><a href="{{url('/view-subcategory')}}">View Sub Category</a></li>
                            </ul>
                        </li>
